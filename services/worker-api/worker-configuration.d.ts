/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=internal` (hash: 4dcc6d3e411c83eb27d5a4bb361eb5be)
// Runtime types generated with workerd@1.20260825.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	TASK_ATTACHMENTS: R2Bucket;
	DOCUMENT_SNAPSHOTS: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	REALTIME_EVENTS: Queue;
	DOCUMENT_MATERIALIZATION: Queue;
	ATTACHMENT_CLEANUP_ENABLED: "true";
	BETTER_AUTH_URL: "https://paca.howlearnwood.com";
	ENVIRONMENT: "internal";
	TRUSTED_ORIGINS: "https://paca.howlearnwood.com";
	ProjectParty: DurableObjectNamespace<import("./src/index").ProjectParty>;
	UserParty: DurableObjectNamespace<import("./src/index").UserParty>;
	DocumentParty: DurableObjectNamespace<import("./src/index").DocumentParty>;
	AgentCoordinator: DurableObjectNamespace<import("./src/index").AgentCoordinator>;
	DOCUMENT_AGENT_WORKFLOW: Workflow<Parameters<import("./src/index").DocumentAgentWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ProjectParty" | "UserParty" | "DocumentParty" | "AgentCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ATTACHMENT_CLEANUP_ENABLED" | "BETTER_AUTH_URL" | "ENVIRONMENT" | "TRUSTED_ORIGINS">> {}
}
